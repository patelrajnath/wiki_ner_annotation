...
class PTwikitextCleaner(object):
    ...
    filter_template = ['unbulleted list','flatlist','hlist','bulleted list','ordered list','plainlist','defn','term', 'glossary','glossary end', 'outdent', 'outdent2','fake heading','col-begin','col-end', 'columns-list' ]
    ...
    # detalhes:
    # https://pt.wikipedia.org/wiki/Ajuda:Guia_de_edi%C3%A7%C3%A3o/Como_usar_imagens#Sintaxe_para_multim%C3%ADdias
    ...
    def _filter_elements(self, prs, tags, templates, wikilinks, sections):
        ...
        # Here the problem is the order of deletion or poorly structured wikitext due to malformation by the user or the manipulations performed by this code
